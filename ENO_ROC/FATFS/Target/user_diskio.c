...
#define SECTOR_COUNT 590 // partitioned filesystem 580/1024 sectors reserved 2.26MB
#define BLOCK_SIZE 1     // @4kB
...
)
{
  /* USER CODE BEGIN STATUS */
    ...
    switch (status) {
    	case FLASHDRV_STATE_NOINIT:
    		Stat = STA_NOINIT;
    		break;
    	case FLASHDRV_STATE_BUSY:
    	case FLASHDRV_STATE_SLEEP:
    	case FLASHDRV_STATE_LOCKED:
    		Stat = STA_PROTECT;
    		break;
    	default:
    		Stat = 0;
...
)
{
  ...
  /* USER CODE HERE */
	...
	// something happened during read/erase op, don't program
...
)
{
  /* USER CODE BEGIN IOCTL */
    ...
    switch(cmd){
    case CTRL_SYNC:
    	// no sync operations, data is directly written to chip
    	res = RES_OK;
    	break;
    case CTRL_TRIM:
    	// nothing to do

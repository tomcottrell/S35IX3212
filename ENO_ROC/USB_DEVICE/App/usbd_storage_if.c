...
#define REAL_BLK_NBR 590  // 564
#define REAL_BLK_SIZ 4096 // @4kB
...
const int8_t STORAGE_Inquirydata_FS[] = {/* 36 */
  ...
  0x00,
  0x00,
  'E', 'N', 'O', 'V', 'A', 'T', 'I', 'O', /* Manufacturer : 8 bytes */
...
int8_t _convertReturnCodes(int fsCode){
  int8_t usbResult = USBD_FAIL;

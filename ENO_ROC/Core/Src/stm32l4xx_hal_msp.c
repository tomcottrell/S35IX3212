...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PC4     ------> ADC1_IN13
    */
    HAL_GPIO_DeInit(GPIOC, ADC_HW_REF_ID1_Pin|ADC_HW_REF_ID0_Pin|ADC_VIN_MEAS_Pin|ADC_AIN_1_Pin);

    HAL_GPIO_DeInit(GPIOA, ADC_DISP_TEMP_Pin|ADC_AIN_2_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C2)
  {
    ...
    PB14     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(RTC_SDA_2_GPIO_Port, RTC_SDA_2_Pin);

    HAL_GPIO_DeInit(RTC_SCL_2_GPIO_Port, RTC_SCL_2_Pin);
...
void HAL_OSPI_MspDeInit(OSPI_HandleTypeDef* hospi)
{
  if(hospi->Instance==OCTOSPI1)
  {
    ...
    PB10     ------> OCTOSPIM_P1_CLK
    */
    HAL_GPIO_DeInit(GPIOA, FLASH_NCS_Pin|FLASH_SIO3_Pin|FLASH_SIO2_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  else if(huart->Instance==USART2)
  {
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOD, RS485_IO_Pin|RS485_TX_Pin);

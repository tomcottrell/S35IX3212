...
protected:
    ...
    /**
     * @brief Implements a horizontal flip operation on a framebuffer
     */
    void HFlip( uint32_t fb );

    /**
     *  @brief Implements a vertical flip operation on a framebuffer
     */
    void VFlip( uint32_t fb );
